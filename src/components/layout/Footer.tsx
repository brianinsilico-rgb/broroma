  ...
  return (
    <footer className="gradient-navy text-white">
      <div className="container-custom py-10 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="inline-block mb-4 md:mb-6">
              <Logo className="h-9 md:h-10 w-auto" variant="white" />
            </Link>
            <p className="text-navy-200 text-sm md:text-base mb-4 md:mb-6 max-w-sm leading-relaxed">
              {t.footer.tagline}
            </p>
            {/* Social Links */}
            <div className="flex gap-3 md:gap-4">
              <a
                href="#"
                className="w-9 h-9 md:w-10 md:h-10 bg-navy-800 hover:bg-navy-700 rounded-lg flex items-center justify-center transition-colors duration-200"
                aria-label="WeChat"
              >
          ...
          {/* Company Links */}
          <div>
            <h4 className="font-heading font-semibold text-base md:text-lg mb-3 md:mb-4">{t.footer.company}</h4>
            <ul className="space-y-2 md:space-y-3">
              {footerLinks.company.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-navy-200 hover:text-white transition-colors duration-200 text-sm md:text-base"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          {/* Products Links */}
          <div>
            <h4 className="font-heading font-semibold text-base md:text-lg mb-3 md:mb-4">{t.footer.products}</h4>
            <ul className="space-y-2 md:space-y-3">
          ...
          {/* Services Links */}
          <div>
            <h4 className="font-heading font-semibold text-base md:text-lg mb-3 md:mb-4">{t.footer.services}</h4>
            <ul className="space-y-2 md:space-y-3">
        ...
        {/* Contact Info Bar */}
        <div className="mt-8 md:mt-12 pt-6 md:pt-8 border-t border-navy-700">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
            <div className="flex items-center gap-2.5 md:gap-3">
              <div className="w-9 h-9 md:w-10 md:h-10 bg-navy-800 rounded-lg flex items-center justify-center flex-shrink-0">
        ...
        {/* Bottom Bar */}
        <div className="pt-6 md:pt-8 border-t border-navy-700 flex flex-col md:flex-row justify-between items-center gap-3 md:gap-4">
