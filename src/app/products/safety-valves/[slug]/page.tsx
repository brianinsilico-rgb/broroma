        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            {Object.entries(safetyValveData)
              ...
              .slice(0, 3)
              .map(([key, v]) => (
                <Link key={key} href={`/products/safety-valves/${key}`} className="card group p-4 sm:p-6">
          ...
          <div className="mt-4 sm:mt-6 text-center">
            <Link href="/products/safety-valves" className="inline-flex items-center text-sm sm:text-base text-navy-900 font-medium hover:text-accent-500 transition-colors py-2">
