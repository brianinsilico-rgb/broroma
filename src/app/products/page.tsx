...
export default function ProductsPage() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="gradient-navy pt-11 sm:pt-16 md:pt-28 pb-8 sm:pb-10 md:pb-14">
        <div className="container-custom">
          <div className="max-w-3xl">
            {/* Breadcrumb — same position as badge (px-3 / px-4) on other main pages */}
            <nav className="flex items-center gap-2 text-sm text-navy-300 pl-3 sm:pl-4 mb-4 sm:mb-6">
            ...
            <p className="text-sm text-steel-400 flex flex-wrap items-center gap-y-1">
              {features.map((feature, index) => (
                <span key={index} className="inline-flex items-center gap-1.5">
                  <span className="text-white/80 [&>svg]:text-steel-400">{feature.icon}</span>
