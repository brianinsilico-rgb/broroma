  ...
  return (
    <>
      ...
      <section className="bg-white border-b border-gray-100 py-6 md:py-8">
        <div className="container-custom">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-2">
            ...
            <span className="text-navy-900">Boiler Tubes</span>
          </nav>
          <h1 className="text-2xl md:text-3xl font-bold text-navy-900">Boiler Tubes</h1>
        </div>
      </section>
      ...
      <section className="py-8 md:py-12 bg-gray-50">
        <div className="container-custom">
          <div className="mb-6">
            <h2 className="text-xl md:text-2xl font-semibold text-navy-900 mb-2">Boiler Tube Materials</h2>
            <p className="text-gray-600 text-sm md:text-base">Choose from our range of boiler tube materials for specific temperature and pressure requirements.</p>
          </div>

          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
            {boilerTubeProducts.map((product) => (
              <Link key={product.slug} href={`/products/boiler-tubes/${product.slug}`} className="group">
