...
const boilerTubeProducts: BoilerTubeProduct[] = [
  {
    slug: "carbon-steel",
    name: "Carbon Steel",
...
export default function BoilerTubesCategoryPage() {
  return (
    <>
      {/* Hero Section */}
      <section className="gradient-navy py-16 md:py-24">
        <div className="container-custom">
          ...
          <nav className="flex items-center gap-2 text-sm text-navy-300 mb-6">
            ...
            <span className="text-white">Boiler Tubes</span>
          </nav>

          {/* Title */}
          <div className="max-w-3xl">
            <h1 className="text-white mb-6">Boiler Tubes</h1>
            <p className="text-xl text-navy-200 leading-relaxed">
              Broroma supplies a comprehensive range of boiler tubes manufactured to international standards including ASTM, EN, and JIS. 
              Our tubes are designed for high-temperature, high-pressure boiler applications in power generation, 
              petrochemical, and industrial facilities worldwide.
            </p>
          </div>
        </div>
      </section>

      {/* Boiler Tube Products Grid */}
        ...
        <div className="container-custom">
          ...
          <div className="mb-10">
            ...
            <p className="text-gray-600 max-w-3xl">
              Choose from our range of boiler tube materials, each engineered for specific temperature ranges, 
              pressure requirements, and corrosion resistance needs.
            </p>
          </div>

          {/* Product Cards Grid - 3 columns desktop, 2 tablet, 1 mobile */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {boilerTubeProducts.map((product) => (
              <Link
                key={product.slug}
                href={`/products/boiler-tubes/${product.slug}`}
                className="group"
              >
        ...
        <div className="container-custom">
          <div className="bg-gradient-to-br from-navy-900 to-navy-950 rounded-3xl p-8 md:p-12 lg:p-16 text-center">
            <h2 className="text-white text-2xl md:text-3xl lg:text-4xl font-semibold mb-4">
              Need Help Selecting the Right Boiler Tubes?
            </h2>
            <p className="text-navy-200 text-lg mb-8 max-w-2xl mx-auto">
              Our technical experts can help you select the optimal material grade and specifications for your boiler application.
            </p>
